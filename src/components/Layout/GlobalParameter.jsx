...
const GlobalSelectionDropdown = () => {
  ...
  const fetchCurrentGlobalParameters = async () => {
    ...
    try {
      const globalParams = await GlobalParameterAPI.getCurrentGlobalParameters(user.orgId, user.userId);
  ...
  const fetchFinancialYears = async () => {
    ...
    try {
      const financialYearData = await GlobalParameterAPI.getFinancialYears(user.orgId);
  ...
  const fetchBranches = async () => {
    ...
    try {
      const branchData = await GlobalParameterAPI.getBranches(user.orgId, user.userName);
  ...
  const fetchCustomers = async (branchcode) => {
    ...
    try {
      const customerData = await GlobalParameterAPI.getCustomer(user.orgId, branchcode, user.userName);
  ...
  const fetchClients = async (branchcode, customer) => {
    ...
    try {
      const clientData = await GlobalParameterAPI.getClients(user.orgId, branchcode, user.userName, customer);
  ...
  const fetchWarehouses = async (branchcode) => {
    ...
    try {
      const warehouseData = await GlobalParameterAPI.getWarehouses(user.orgId, branchcode);
